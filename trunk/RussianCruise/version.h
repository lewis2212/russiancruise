...
namespace AutoVersion{
	...
	static const long RC_BUILD = 6;
	static const long RC_REVISION = 46;
	
	//Miscellaneous Version Types
	static const long RC_BUILDS_COUNT = 306;
	#define RC_RC_FILEVERSION 1,2,6,46
	#define RC_RC_FILEVERSION_STRING "1, 2, 6, 46\0"
	static const char RC_FULLVERSION_STRING[] = "1.2.6.46";
