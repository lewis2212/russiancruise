...
int Pizza::init(void *classname,void *CInSim, void *Message)
{
...
void Pizza::deal(struct PizzaPlayer *splayer)
{
...
void Pizza::take(struct PizzaPlayer *splayer)
{
...
void Pizza::done(struct PizzaPlayer *splayer)
{
...
void Pizza::undeal(struct PizzaPlayer *splayer, char *Reason)
{
...
void Pizza::readconfig(char *Track)
{
    //cout << "Pizza::readconfig\n" ;
    char file[MAX_PATH];
...
void Pizza::btn_work (struct PizzaPlayer *splayer)
{
    struct IS_BTN pack;
...
int Pizza::check_pos(struct PizzaPlayer *splayer)
{
...
void Pizza::send_mtc (byte UCID,char* Msg)
{
...
void Pizza::send_bfn (byte UCID, byte ClickID)
{
    struct IS_BFN pack;
